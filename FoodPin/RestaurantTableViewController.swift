...
class RestaurantTableViewController: UITableViewController {
    ...
    /*override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if !restaurantIsVisited[indexPath.row] {
            ...
            let undoCheckiAction = UIAlertAction(title: "Undo Check in",
                                                 style: .default,
                                                 handler: { (action) in
                                                    let cell = tableView.cellForRow(at: indexPath)
            ...
            optionMenu.addAction(undoCheckiAction)
        }
    ...
    override func tableView(_ tableView: UITableView, editActionsForRowAt indexPath: IndexPath) -> [UITableViewRowAction]? {
        ...
        let shareAction = UITableViewRowAction(style: .default,
                                               title: "Share") { (action, indexPath) in
                                                ...
                                                let imageToShare = UIImage(named: self.restaurants[indexPath.row].image)!
